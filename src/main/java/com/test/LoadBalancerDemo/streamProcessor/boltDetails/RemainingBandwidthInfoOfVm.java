...
public class RemainingBandwidthInfoOfVm {
    ...
    public RemainingBandwidthInfoOfVm(float remainingInBandwidth, float remainingOutBandwidth, float remainingInBandwidthPercentage, float remainingOutBandwidthPercentage) {
